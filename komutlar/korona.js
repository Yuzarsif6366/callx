...
exports.run = async (client, message, args) => {
  if(!args[0]) return message.reply('𝘾𝙊𝙍𝙊𝙉𝘼 𝙑𝙄𝙍𝙐𝙎 𝘼𝙉𝙇𝙄𝙆 𝙄𝙎𝙏𝘼𝙏𝙄𝙎𝙏𝙄𝙆 𝙏𝘼𝘽𝙇𝙊𝙎𝙐 𝙆𝙐𝙇𝙇𝘼𝙉𝙄𝙈 **__Güncel Covid-19 vaka istatistiklerini buradan görebilirsin. Ülkeye özel istatistikler için o!korona <ülke kodu> komutunu kullanabilirsin.__** **Önrek o!corona TR, o!corona JP, o!corona US, o!corona FR, o!corona NE, o!corona SN** #evdekal **Doğru Kullanım:** __o!korona TR__')
  ...
  let ülk = body.countrydata[0].info.title
    ...
    .setTimestamp()
    .setFooter('Alpha | COVID-19 İstatistik', client.user.avatarURL);
